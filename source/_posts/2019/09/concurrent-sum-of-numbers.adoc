...
===== {fork-join-pool-javadoc-url}[ForkJoinPool] and {base-stream-parallel-javadoc-url}[Stream.parallel]
...
public class DivideAndConquerSum {
    ...
    public static void main(String[] args) throws InterruptedException {
        try (Scanner input = new Scanner(System.in)) {
            ...
            int sum = MultiThreadedSum.sum(rangeStart, rangeEnd, numberOfThreads);
